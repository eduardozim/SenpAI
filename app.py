...
Suporta Navegação Multi-Páginas (Arbitragem de Lutas & Página de Configurações Separada).
"""
...
# ==============================================================================
    ...
    # --- SIDEBAR DA ANÁLISE: SELEÇÃO DE MODO E PERFIL ---
    ...
    # CARREGAMENTO DE VÍDEO E EXECUÇÃO DA ARBITRAGEM
